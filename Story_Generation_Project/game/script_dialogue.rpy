...
label test_dialogue_screen1:
    call screen test_dialogue_screen()

label test_dialogue_screen2:
    $ sentence = getDialogue()
    e "[sentence]"
    call test_dialogue_screen1()

label exit_dialogue_screen:
    scene black
    call start()
...
screen test_dialogue_screen():
    ...
    textbutton "{size=28}{color=#FFF}Player Study +{/color}{/size}":
        ...
        xpos 1000
        ypos 200
        action [SetVariable("statType",1),SetVariable("statValue",5), Jump("update_test_stat")]
    textbutton "{size=28}{color=#FFF}Player Study -{/color}{/size}":
        background "#000"
        xpos 1300
        ypos 200
    ...
    textbutton "{size=28}{color=#FFF}Player Social +{/color}{/size}":
        ...
        xpos 1000
        ypos 250
        action [SetVariable("statType",2),SetVariable("statValue",5), Jump("update_test_stat")]
    textbutton "{size=28}{color=#FFF}Player Social -{/color}{/size}":
        background "#000"
        xpos 1300
        ypos 250
    ...
    textbutton "{size=28}{color=#FFF}Player Health +{/color}{/size}":
        ...
        xpos 1000
        ypos 300
        action [SetVariable("statType",3),SetVariable("statValue",5), Jump("update_test_stat")]
    textbutton "{size=28}{color=#FFF}Player Health -{/color}{/size}":
        background "#000"
        xpos 1300
        ypos 300
    ...
    textbutton "{size=28}{color=#FFF}NPC Study +{/color}{/size}":
        ...
        xpos 1000
        ypos 350
        action [SetVariable("statType",4),SetVariable("statValue",5), Jump("update_test_stat")]
    textbutton "{size=28}{color=#FFF}NPC Study -{/color}{/size}":
        background "#000"
        xpos 1300
        ypos 350
    ...
    textbutton "{size=28}{color=#FFF}NPC Social +{/color}{/size}":
        ...
        xpos 1000
        ypos 400
        action [SetVariable("statType",5),SetVariable("statValue",5), Jump("update_test_stat")]
    textbutton "{size=28}{color=#FFF}NPC Social -{/color}{/size}":
        background "#000"
        xpos 1300
        ypos 400
    ...
    textbutton "{size=28}{color=#FFF}NPC Health +{/color}{/size}":
        ...
        xpos 1000
        ypos 450
        action [SetVariable("statType",6),SetVariable("statValue",5), Jump("update_test_stat")]
    textbutton "{size=28}{color=#FFF}NPC Health -{/color}{/size}":
        background "#000"
        xpos 1300
        ypos 450
    ...
    textbutton "{size=28}{color=#FFF}Change Location{/color}{/size}":
        ...
        xpos 1300
        ypos 500
        action [SetVariable("statType",7),SetVariable("statValue",1), Jump("update_test_stat")]


    textbutton "{size=28}{color=#FFF}Display Dialogue{/color}{/size}":
        background "#000"
        xpos 1000
        ypos 600
        action Jump("test_dialogue_screen2")
    textbutton "{size=28}{color=#FFF}Reset Dialogue{/color}{/size}":
        background "#000"
        xpos 1300
        ypos 600
        action Jump("reset_test_dialogue")
    textbutton "{size=28}{color=#FFF}Exit Test{/color}{/size}":
        background "#000"
        xpos 1600
        ypos 600
        action Jump("exit_dialogue_screen")
